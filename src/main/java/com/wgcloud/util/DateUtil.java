...
public class DateUtil {
     ...
     * Default template format yyyy-MM-dd hh:mm:ss.
     *
    ...
    /**
     * Get the current system during the same period.
     *
     ...
     * Get the current system time.
     *
     * @param strPattern Time template
     * @return Current system time
     */
    ...
    public static String getDateBefore(String datetimes, int day) {
        ...
        try {
            ...
            logger.error("Time format [ " + datetimes + " ]  Unable to be analyzed:" + e.toString());
            return null;
        }
